...
CREATE TABLE user_business_waste_details (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    business_profile_id BIGINT REFERENCES user_business_profiles(id) NOT NULL,
...
CREATE INDEX business_profiles_user_id_idx ON user_business_profiles(user_id);
CREATE INDEX business_waste_details_profile_id_idx ON user_business_waste_details(business_profile_id);
